...
<%
    ...
    switch(currentLang) {
        case "chinese":
            wordLabel = "Chinese Character:";
            wordPlaceholder = "e.g., 猫";
            pronLabel = "Pinyin:";
            pronPlaceholder = "e.g., māo";
            engPlaceholder = "e.g., Cat";
            break;
        case "russian":
            wordLabel = "Russian Word (Cyrillic):";
            wordPlaceholder = "e.g., Спасибо";
            pronLabel = "Pronunciation:";
            pronPlaceholder = "e.g., spa-SI-bo";
            engPlaceholder = "e.g., Thank you";
            break;
        case "turkish":
            wordLabel = "Turkish Word:";
        ...
        case "italian":
            ...
            break;
        default:
            wordLabel = "Target Word:";
            wordPlaceholder = "e.g., Word";
            pronLabel = "Pronunciation:";
            pronPlaceholder = "e.g., Pronunciation";
            engPlaceholder = "e.g., Meaning";
    }

    // 2. Securely load the database credentials
